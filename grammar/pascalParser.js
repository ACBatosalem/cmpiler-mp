...
pascalParser.prototype.writeln = function() {
    ...
    try {
        ...
        while(_la===pascalParser.LP) {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while(((((_la - 33)) & ~0x1f) == 0 && ((1 << (_la - 33)) & ((1 << (pascalParser.ADD - 33)) | (1 << (pascalParser.SUB - 33)) | (1 << (pascalParser.AT - 33)) | (1 << (pascalParser.TRUE - 33)) | (1 << (pascalParser.FALSE - 33)) | (1 << (pascalParser.NUMBER - 33)))) !== 0) || ((((_la - 65)) & ~0x1f) == 0 && ((1 << (_la - 65)) & ((1 << (pascalParser.ID - 65)) | (1 << (pascalParser.CHAR_LITERAL - 65)) | (1 << (pascalParser.STRING_LITERAL - 65)))) !== 0)) {
                this.state = 361;
                this.outputList();
                this.state = 366;
                this._errHandler.sync(this);
