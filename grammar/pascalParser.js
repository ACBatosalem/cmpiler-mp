...
SimpleStatementContext.prototype.functionDesignator = function() {
    return this.getTypedRuleContext(FunctionDesignatorContext,0);
};
...
pascalParser.prototype.expression = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 43)) & ~0x1f) == 0 && ((1 << (_la - 43)) & ((1 << (pascalParser.EQUAL - 43)) | (1 << (pascalParser.NOT_EQUAL - 43)) | (1 << (pascalParser.LT - 43)) | (1 << (pascalParser.LE - 43)) | (1 << (pascalParser.GE - 43)) | (1 << (pascalParser.GT - 43)))) !== 0)) {
            this.state = 437;
...
SimpleExpressionContext.prototype.additiveoperator = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
TermContext.prototype.signedFactor = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
        return this.getTypedRuleContexts(SignedFactorContext);
    } else {
        return this.getTypedRuleContext(SignedFactorContext,i);
    }
};

TermContext.prototype.multiplicativeoperator = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
pascalParser.prototype.term = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << pascalParser.AND) | (1 << pascalParser.DIV) | (1 << pascalParser.MOD))) !== 0) || _la===pascalParser.MULT) {
            this.state = 459;
